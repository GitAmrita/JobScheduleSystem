import SchedulerJob.DoubleLinkedList;
import SchedulerJob.Job;
import SchedulerJob.Node;
...
public class DoubleLinkedListTests {
    ...
    public void getNext_test() {
        DoubleLinkedList testObj = new DoubleLinkedList();
        Job j1 = new Job(1, "j1"); Job j2 = new Job(2, "j2");
        Job j3 = new Job(3, "j3"); Job j4 = new Job(4, "j4");
    ...
    public void removeFirst_test() {
        ...
        Assert.assertEquals(job.name, "j1");
    }
    ...
    public void removeLast_test() {
        ...
        Assert.assertEquals(testObj.size(), 3);
        Assert.assertEquals(job.name, "j4");
    }
